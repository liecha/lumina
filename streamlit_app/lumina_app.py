...
from scripts.error_handling import (
    error_handler, handle_errors, loading_indicator, safe_dataframe_operation
)
...
try:
    from scripts.data_storage import fetch_data_from_storage, save_data_to_storage, delete_item_from_dataset, sync_csv_to_database
...
with st.sidebar:
    ...
    with st.expander("⚙️ Settings", expanded=False):
        ...
        # Replace this section around line 110
        try:
            ...
            # Fallback if session state is corrupted
            st.error("Session state issue detected. Please refresh the page.")
            weight = 50.0
        ...
        height = st.number_input(
            ...
            key="user_height_input",  # Add unique key
        )
        ...
        age = st.number_input(
            ...
            key="user_age_input",  # Add unique key
        )
